...
animals <- c("Antelope", "Bison", "Cat")

length_vector <- c()

for (a in animals)
{
  # Call nchar on each element in the loop sequence
  length_vector <- c(length_vector, nchar(a))
}

length_vector


length_list <- lapply(animals, nchar)

library(purrr)
length_list <- map(animals, nchar)
